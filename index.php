...
?>
	    ...
	    <p>The "other side" of the project is less convincing. It is the SocioEconomic impact and the Ecocide which will affect communities and the environment due to SKA phase 1, and the later phases 2 and 3. Construction of phase 1 is planned to start soon. Later SKA phases 2 and 3 are planned to reach far into the African Continent. According to the <a href=Documents/79_Report_of_The_Expert_Panel_on_Radio_Quiet_Zone_and_RFI_Regulation.pdf>Radio Quiet Zone Document</a>, page 10, remote stations are proposed to be placed in Botswana, Ghana, Kenya, Madagascar, Mauritius, Mozambique, Namibia and Zambia. The RQZ document goes on to state that these African countries have "basic law", implying  that enforcing a RQZ would be possible.</p>
	    <p>The current SKA site in the Karoo consists of two farms (Losberg and Meysdam) and covers 13,406 ha. Here pathfinder and precursor radio telescope dishes have been erected. The Kat-7 project, a test bed of seven dishes, was completed years ago. The MeerKAT project will eventually comprise of 64 dishes, a technology demonstrator for South Africa's bid to host the Square Kilometer Array, is under construction and will form part of SKA phase 1. MeerKat is still far form completion, and has suffered many delays.</p>
<p> <img class="img-responsive" src="img/kat7.jpg" alt="Kat7">
 <figcaption class="figure-caption text-right">The seven-dish MeerKAT precursor array, KAT-7</figcaption></p>

	
 
        <p> South Africa and Australia jointly won the bid in 2012 and are both official hosts, but South Africa will host the majority share. <a href=Documents/SKA-Site-Advisory-Committee-16-Feb-2012.pdf>An International Site Advisory Committee decided which criteria determined the SKA host</a>. The South African SKA foundation is currently negotiating to buy more land (about 118 000 ha / or + - 36 farms) around the initial site, to create a larger core area of about 130 000 ha.</p>
        <p>SKA phase 1 does not only consist of the above mentioned core area, but also includes three long arm-like spiralling corridors. Along these corridors additional satellite dishes are to be constructed. These corridors are planned to run over "active farms". Servitudes on roads, power lines and pockets of land are planned. Construction along the spirals are expected to interupt farming activities over extended periods. Along these spirals restrictions will protect radio astronomy and affect farming activities for up to 11 km on either side of the spirals, totaling corridors of 22 km (or more in places) in width. These restrictions reduce or prohibit the generation of  power via certain generators, wind chargers and solar panels. Electric fencing, spark plugs (petrol driven vehicles included),flying an aeroplane, constructing roads and houses, broadcasting a radio signals, operating microwaves, arc welding and the use of certain machines will be prohibited or restricted. Even appliances like TV`s, decoders, stoves, fridges, washing machines, electric geysers, alarm systems, remote controls, laptops, printers, digital cameras, lathes, trucks and bulldozers or graders will be restricted. Cell phones are banned outright. A SKA official, Mr Adrian Tiplady, confirmed that signals have been "modified" in the past, and will continue to be "modified" to protect radio astronomy. The scientific term of "modification" in practical terms results in the loss of mobile communication systems. Only radio frequencies below 100 Mhz, and above 25.5 Ghz will be tolerated. Therefore the use of mobile handhelds will become impossible</p>
        
        <p><figure class="figure">
        <img class="img-responsive" src="img/sea-study-area.jpg" alt="SEA study area">
	<figcaption class="figure-caption text-right"> The total SEA area (SKA phase 1) comprises of 268 000 ha. Restrictions diminish farming activity beyond the wide corridors indicated in blue.</figcaption>
	</figure></p>
	    ...
	    <ul>
            ...
            <li><a href="#impacts">Impacts, Aviation and Communication</a></li>
            <li><a href="#council-for-scientific-and-industrial-research-(CSIR)">Council for Scientific and Industrial Research - (CSIR)<a></li>
	...
	<p>
	  <figure class="figure">
        ...
        <img class="img-responsive" src="img/sheep.jpg" alt="merino sheep">
	     ...
	     <p>Estimates as to how farming activities along the intended spiraling corridors will be economically affected due to the regulations and restrictions are tricky to calculate. Land management and preservation without the use of machines and equipment might be impossible in the long run, and cause environmental damage. The inconveniences caused by the regulations and the absence of technological development associated with radio frequencies could in time deter younger generations from farming in the area. The remote monitoring equipment allowing modern and convenient farming practices will most likely be prohibited, and pose safety threats. This will cause a substantial loss in income for these farms and all the dependants. Farms could be reduced to stock posts in due course. Stock posts are typically less productive, contribute to falling populations figures and reduced incomes. The migration patterns from rural to urban areas stress many big cities in South Africa already. Where unemployment, lack of accommodation, poor living conditions, increased crime, transport, health, sanitation and hygiene are mayor expenses to the national economy. Functioning agricultural and rural communities alleviate problems in cities and improve the population distribution of a nation. Agricultural communities feed those who live in cities, and it seems politicians and scientist forget the roll agtriculture plays within a nations well-being and stability.</p>

	     <h3>Food security</h3>

	     <p>Economics, productivity, human resources and food security cannot be separated. Food security has been an issue in Southern Africa, especially after recent droughts. Currently 25 percent of South Africa's sheep are found in the Northern Cape, according to National livestock Statistics. Therefore this area contributes substantially to the national food basket and national revenue, despite its relatively low population.</p>
	     ...
	     <h3>SKA makes some contributions to a local town</h3>

	     <p>SKA has donated computers for educational purpose in Carnarvon. Five students received bursaries for further studies, and SKA employed a member of staff at the Carnarvon school. Some locals are employed to develop SKA infrastructure during construction, but this ends once construction is completed. SKA officials have proposed employing farm workers, who stand to lose their jobs, eradicating invasive trees in the area. However, farm workers are a very specialised workforce and might not want to chop down trees for a living. SKA may inform Save The Karoo about the benefits Williston, Van Wyksvlei and Brandvlei have received so these benefits may be included on this site. Certain handouts might instil a situation where dependency and expectations grow, whereas others may encourage own initiative. Donations which directly stimulate financial growth and alternative work opportunities in the area would be most effective. SKA's intentions and policies with regard to donations and uplifting the Karoo in the long term has not been explained to the public. The sustainability of support from SKA and the way forward is therefore unclear. Considering that constructions may take several decades and that a fully operational SKA is expected to run for around 50 years, the public must understand SKA policies and agree to them.</p>

         <p>The <a href=http://www.skaphase1.csir.co.za/wp-content/uploads/2015/03/SKA-IEMP-2016-1.pdf>CSIR report</a> mentions 9 points of advantages which SKA will bring to the affected area. Firstly these points must be examined one by one. Much of what is stated has not occurred to date, despite SKA presence in the area since 2007. Phase 1 will soon displace people, but the promised facilities mentioned in the CSIR document are not in place. And even if these goals will one day be achieved these advantages will benefit a very small area and just touch a few lives in comparison to the scale of phase 1, let alone phases 2 and 3. It is questioned whether much of the work force for future construction will be imported from far away, housed on site and treated in a on-site clinic, disadvantaging the local workforce further. SKA have been asked to comment in this regard, but locals are eagerly awaiting an answer.</p>

         <h2 id="environmental-impact">Environmental impact</h2>
         
         <p>The CSIR include expert Studies such as <a href=http://www.skaphase1.csir.co.za/wp-content/uploads/2017/01/Agriculture-Soils-Assessment.pdf>Agriculture Soil Assessment</a>, <a href=http://www.skaphase1.csir.co.za/wp-content/uploads/2017/01/Alien-Invasive-Study.pdf>Alien Invasive Study</a>, <a href=http://www.skaphase1.csir.co.za/wp-content/uploads/2017/01/Aquatic-Assessment.pdf>Aquatic Assessment</a>, <a href=http://www.skaphase1.csir.co.za/wp-content/uploads/2017/01/Avifauna-survey.pdf>Avifauna Survey</a>, <a href=http://www.skaphase1.csir.co.za/wp-content/uploads/2017/01/Bat-survey.pdf>Bat Survey</a>, <a href=http://www.skaphase1.csir.co.za/wp-content/uploads/2017/01/Ecology-Assessment.pdf>Ecology Assessment</a>, and the <a href=http://www.skaphase1.csir.co.za/wp-content/uploads/2017/01/Endangered-Wildlife-Trust-Survey.pdf>Endangered Wildlife Trust survey</a>.</p>
	     ...
	     <p>Wild animals in the Karoo have adapted to farming conditions and live in synchronized relationship with farming stock. It is no longer possible for wild animals to migrate according to water availability as they did in former times before fences were introduced to the area. The wild animals use the drinking facilities available on farms. Many animal species are protected and endangered in the Karoo. Particular attention must be given to the riverine rabbit, birds of prey, in particular the Verreaux eagle, the blue crane, tortoises, steenbokkies, springbok, porcupines and the aardvark, to give just a few examples. It has been SKA policy to close water holes and drinking facilities on the two farms they have owned for years already, thus leaving no drinking facilities for animals in the wild. Should SKA expand and continue this practice it would amount to further mass destruction among these beautiful and rare species as they would simply dehydrate and die. </p>
	          <figure class="figure">
        <img class="img-responsive" src="img/springbok-drinking.jpg" alt="springbok drinking">
	
	</figure>
	
	
	<figure class="figure">
        <img class="img-responsive" src="img/bird-drinking.jpg" alt="bird drinking">
	...
	<figure class="figure">
        <img class="img-responsive" src="img/ska-meerKAT.jpg" alt="MeerKAT">
	<figcaption class="figure-caption text-right">The MeerKAT will finally consist of 64 dishes. SKA phase 1 will consist of thousands of satellite dishes</figcaption>
	</figure>
	     ...
	     <p>The number of registered homeless people in Carnarvon is 61, but according to a municipal employee, this figure is incomplete and could be much higher. There are several areas with shacks, people who sleep under the open sky, and overcrowded homes where large extended families are crammed into a small space. Social work is plentiful, and abusive substances pose a problem particularly with the youth and the lack of opportunities. The South African government is spending "astronomical" amounts on SKA while many of its people living in the area are in dire need of basic facilities. Funds to the tune of R 600 000 recently disappeared out of the municipal coffers intended for a local soup kitchen to feed the poor. Social and political problems are escalating and resentment and conflict may grow further.</p>
	     ...
	     <p>There are dinosaur fossils in the Karoo as it was a swamp millions of years ago. Rock art, spearheads, remnants of early settlements and stone constructions are frequently found. These are often places of spiritual value to former inhabitants of the area and rightfully deserve to be honoured. Corbelled houses are unique to the area. There are very old and artistically crafted gravestones on farms where cemeteries house 5 or 6 generation. Some farms have beautiful old Victorian homes. Many towns have Victorian and Art Deco homes or structures and some of the early churches are true heritage gems. Simple stone masonry work of a by gone era with pleasing proportions adorn towns and farms. There are <a href=40-heritage-sites-in-carnarvon.php>40 heritage sites listed in Carnarvon</a>.  Examples for <a href=http://www.karoo-southafrica.co.za/?page_id=652>Williston</a> and <a href=http://www.carnarvon.co.za/our_wonderful_heritage.htm>Carnarvon</a></p>
	     
	     <p>
	     	<figure class="figure">
        <img class="img-responsive" src="img/osfontein-corbeled-house.jpg" alt="Corbeled house in the Karoo">
	<figcaption class="figure-caption text-right"></figcaption>
	</figure>
	     </p>

         <p>Authors past and present of note come from this area or still reside here. And many famous stories and legends find their origin in this unique, hardy and somewhat rugged place. The extremities of the land and weather conditions are reflected in peoples faces, their moods and attitude. This is the stuff that makes them so different, so honest and real, and so like-able. There is sadness from the past and there is still hunger and need, and there is fear for the future is now unknown... But there is always time to talk, time for a handshake and time for a kind word, or argument. Life happens on the street, and people like to talk and laugh together. People have nicknames, very funny ones. Humour acts like cements and unites people at the core. <a href=https://en.wikipedia.org/wiki/People_of_the_Karoo>Here are some famous characters form the Karoo</a></p>

         <p>Rhythm, joy, passionate belief and song flow from churches every Sunday morning. Souls uplift...joy and rhythm, rhythm and joy! Dance, in rhythm and joy with the people of the Northern Cape, and they will dance with you in joy. It is captivating, simply captivating. One example is the <a href=https://af.wikipedia.org/wiki/Rynse_Sendinggenootskap>VG Kerk</a></p>

         <p> And then there is the <a href=https://www.youtube.com/watch?v=rXdoYlqb-cM>Riel dance</a>, a traditional dance performed in the dust...It is an age-old dance of the <a href=http://www.san.org.za/history.php>Khoisan</a> performed to the beat of "boeremusiek", especially in the Karoo and Northern Cape.</p>      
         
         
         <p>For more information see CSIR's <a href=http://www.skaphase1.csir.co.za/wp-content/uploads/2017/01/Heritage-Assessment.pdf>Heritage Assessment</a>.</p>

         <h2 id="Public-Participation-Process">Public Participation Process</h2>

         <p>The Department of Science and Technology (DST) ran several workshops to engage with locals about SKA phase 1. Stakeholders were encouraged to object in writing rather than through debate at the meetings. Many written representations were forwarded to the DST but there are no known accounts of answers or solutions in return. Unfortunately these meetings were not well advertised and this limited participation. The minutes to these meetings were never shared with the public, and so continued discussion, negotiations and problem solving became impossible. The public is ill-informed despite a multitude of meetings where transparency or solutions have not been offered.</p>
         
         <p>SKA representatives have also regularly held meetings with local inhabitants, but no minutes were supplied either. It became common practise at the opening of meetings hosted by SKA for a representative to firstly admit that the organisation had not behaved in a transparent manner in the past, but that it would change with immediate effect and act within the publics interest. The public would then be requested to be trusting of SKA's and its good will. Such comments have been repeated at almost every public meeting. However the minutes of these meetings were not supplied but rather continued to be withheld despite several requests. Some SKA officials have persistantly claimed at public meetings that a phase 2 is a mere dream and will never happen. This is clearly to calm people down as the project threatens to swallow more and more space, while displacing more and more people. There is a lot of literature on the later phases and even agreements with other African countries, and most of the public has read and researched much about the later phases. 

         <p>The lack of minutes after meetings resulted in a disruption of the public participation process, and inadequate communication. The missing minutes, lack of certain impact studies, outstanding answers from the DST and SKA have left the public in a vacuum. Late in 2016 SKA invited stakeholders along the intended corridor arms to information sessions. Some people were surprised to discover, at that late stage, that they were stakeholders.  By then the SEA was completed and these people were denied participation in the public participation process completely.</p>

         <p>The public demanded to see the earliest impact studies, public participation and Expert reports before the AGA Act of 2007, and are still waiting for documents. Which laws allow for such an Act without the public having access to all the information about the project in advance?  Environmental Impact Assessments of <a href=http://www.ska.ac.za/wp-content/uploads/2016/11/skasa_final_eia_report_2007.pdf>2007</a> and <a href=http://www.ska.ac.za/wp-content/uploads/2016/11/skasa_eia_report_2009.pdf>2009</a> concerned with Kat7 and MeerKat respectively are available. The AGA Act, however, written in 2007 allows for SKA phase 1, further phases, and turning much of the Northern Cape into a Radio Quite Zone.</p> 
	     <li>Save The Karoo asks for clarity about the <a href=http://www.kruger2canyons.org/029%20-%20NEMA.pdf>Natural Environment Management Act (NEMA)</a> and the impact SKA will have on the environment and peoples well-being. </li>
         <li>Please comment on the <a href=http://eradicatingecocide.com/the-law/>International Law</a> . The ICC extended its remit in September 2016 to include ecocide in the existing Human Rights law. This is preparing a way forward for Ecocide Laws to stand independantly and for our planet and its citizens to enjoy a higher level of protection. Please explain why the South African Government cancelled its ICC membership in October 2016. How could this happen without a public participation process?</li>
	     <li>Please explain why the public's formal written objections, have not been answered in months or years.</li>
	     <li>Why was an impact study not completed before cell phone signals were "modified" ("cut off" in layman's terms), and why was mobile connectivity not addressed directly, but only expressed in terms of radio frequency restrictions? Why are walkie talkies a suggested substitute when they have nothing to do with mobile connectivity, Internet and Aps? Since 2007 SKA has repeatedly stated that it would uplift the affected area and improve conditions. Good things were promised especailly in 2007, but the reality is showing a different picture as SKA is preparing to expand.</li>
         ...
         <p>The Central Karoo Astronomically Advantaged Area (CKAAA) was first stipulated in the AGA Act of 2007. Later, on the 19 February 2010, the minister of Science and Technology declared the whole of the Northern Cape (green province on the map) an AAA, excluding only Sol Plaaatje municipality with Kimberley as the capital. Therefore all Northern Cape  municipalities excluding one could in future be affected and regulated. Only radio frequencies below 100 Mhz, and above 25.5 Ghz will not be subject to restriction. This potentially turns the province into a silent reserve or RQZ (Radio Quiet Zone). Will the air space above this province become a no-fly zone? Will mobile communication be lost? South African statistics show that the population of the Northern Cape is 1 150 900, and that the population of the Sol Plaatjie municipality is 250 000.</p>
          
         <p>The future of about 950 000 people will be potentially impacted in the Northern Cape by further SKA expansion.</p>
          
         <h3>The Central Karoo AAA falls in the heart-land of organic meat and wool production.</h3> 
         <p>Here a more affluent agriculturally based economy exists than in many other parts of the Northern Cape.</p> 
          
         <p>
          
        <figure class="figure">
        <img class="img-responsive" src="img/map-of-south-africa.png" alt="Map of south africa">
	<figcaption class="figure-caption text-right">Red line indicates the area which was declared an Astronomically Advantaged Area (AAA) in the AGA Act of 2007. In 2010 the Minister of the Department of Science and Technology declared the entire Northern Cape (shown in lime green on the map), an AAA, excluding only the Sol Plaatjie municipality.</figcaption>
	</figure></p><br>
	
	
	    <p>Total area of Central Karoo AAA is 104691.254 km2. The total area of the Northern Cape is roughly 372 8000 km2, and <a href=Documents/memorandum-AAA.pdf> most of the province was declared a AAA in 2010</a>.</p>
        


        <p>The perimeter of the Central Karoo AAA is  1 240.357 km. The perimeters along the spiralling corridors regulated by legislation, will be far greater, affecting thousands of commercial farms.</p>
        
	
          
        <p><u>The size of the Central Karoo AAA, comparison to other well know areas:</u></p>
        
        
        
131,957 km2 - Greece <br>
116,096 km2 - Ohio (USA) <br>
113,729 km2 - North Island (New Zealand) <br>
104,691 km2 - Central Karoo Astronomically Advantaged Area <br>
104,659 km2 - Kentucky (USA) <br>
102,775 km2 - Iceland <br>
84,421 km2 - Ireland (island size, not Republic of Ireland size)<br>
83,879 km2 - Austria <br>
68,401 km2 - Tasmania (Australia)</p>

        

	
	<figure class="figure">
        <img class="img-responsive" src="img/skamap1.jpg" alt="ska map">
	<figcaption class="figure-caption text-right"></figcaption>
	</figure>
	     ...
	     <p>On the 23 rd November 2015, the Department of Science and Technology published <a href=http://www.gov.za/sites/www.gov.za/files/39442_gon1166s.pdf>Government Gazette number 1166</a>. Eight corridors are indicated within the AAA. The following quote accompanies this map; " The map below depicts the protection corridors required for approximately 54 SKA  radio  astronomy  stations  located  within  the  Karoo  Central  Astronomy  Advantage  Area  1".  Save The Karoo would like to apologize for the poor quality of the corridor maps, but these are the best maps received from the Department of Science and Technology to date.</p>
	     
	     
	     	
	<figure class="figure">
        <img class="img-responsive" src="img/8-spiral-AAA.png" alt="8 spiral AAA">
	<figcaption class="figure-caption text-right"></figcaption>
	</figure>
	     ...
	     <p>Australia's chosen site is situated in the Murchison Shire. According to <a href="http://www.ska.gov.au/">SKA Australia</a>, the site covers an area almost the size of the Netherlands, but only one hundred people live there. The population density of the Australian site is a mere fraction of the population density of the South Africa site. The population densities at the SKA site in Australia and the population density at the SKA site in South African site compare as follows:</p>

                 <h3>Shire of Murchison, Western Australia</h3>                                                                                                                                                                      

 - Population of 121  [2014] (Source: Australian Bureau of Statistics, 3218.0 Regional Population Growth, Australia)<br>                                                                                     

 - Area of 45,030.2 km2 (Source: Australian Bureau of Statistics, 3218.0 Regional Population Growth, Australia)<br>                                                                                           

 - Population Density of 0.0 persons/km2 [2014] (Source: Australian Bureau of Statistics, 3218.0 Regional Population Growth, Australia)<br>                                                                  

 - Known as the "Shire with no Town", as no gazetted town site exists (Source: Shire of Murchison)<br>                                                                                                        

 - It is believed to be the only Shire in Australia where this exists (Source: Shire of Murchison)<br>                                                                                                       

 - It is the second least populated Local Government Area in Australia (Source: Murchison Shire Annual Report 2014-2015)<br>                                                                                 

 - Total number of businesses 3  [2013] (Source: Australian Bureau of Statistics)</p>                                                                                                                         


             <h3>Northern Cape, South Africa</h3>                                                                                                                                                                              

 - Population of 1,145,861 (Source: Statistics South Africa)<br>                                                                                                                                             

 - 27 Municipalities of the Northern Cape, South Africa<br> 
 
 - 3 Municipalities will be impacted should SKA phase 1 be constructed, affecting a population of 46 000 people.<br> 

 - Population Densities ranging from 0.3 - 78.9 persons/km2.  (Statistics South Africa, www.statssa.gov.za/census2011)<br>
 
 - Kgalagadi Transfrontier Park and Kalahari Desert are situated in the north, with few inhabitants, reducing average population statistics in the Northern Cape.<br>
 
 - Total land area 372 889.36 km2.</p>

	    <h2 id="epilogue">Epilogue</h2>

	    <p>The people of the Karoo are asking the SKA International Partners States and the SKA Non-Partner States to take a close look at the SKA SA project which they are financing. Please consider the inhabitants of the Northern Cape and Africa now and in the future. The people of the Karoo need to be protected and future generations, including the unborn, need to be protected. The natural environment on which we depend must be protected from exploitation, destruction and from ecocide.</p>	      
