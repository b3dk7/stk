...
?>
	    ...
	    <p>The "other side" of the project is less convincing. It is the Ecocide which will affect communities and the environment due to SKA phase 1, and the later phases 2 and 3. Construction of phase 1 is planned to start in 2018. Later SKA phases 2 and 3 are planned and will finally reach far into the African Continent. According to the <a href=Documents/79_Report_of_The_Expert_Panel_on_Radio_Quiet_Zone_and_RFI_Regulation.pdf>Radio Quiet Zone Document</a>, page 10, remote stations are proposed to be placed in Botswana, Ghana, Kenya, Madagascar, Mauritius, Mozambique, Namibia and Zambia. The RQZ document goes on to state that these African countries have "basic law", implying  that enforcing a RQZ would be possible.</p>
	    <p>The current SKA site in the Karoo consists of two farms (Losberg and Meysdam) and covers 13,406 ha. Here pathfinder and precursor radio telescope dishes have been erected. The Kat-7 project, a test bed of seven dishes, was completed years ago. The MeerKAT project of 64 dishes, a technology demonstrator for South Africa's bid to host the Square Kilometer Array, is under construction and will form part of SKA phase 1.</p>
<p> <img class="img-responsive" src="img/kat7.jpg" alt="Kat7">
 <figcaption class="figure-caption text-right">The seven-dish MeerKAT precursor array, KAT-7</figcaption></p>
        ...
        <p>SKA phase 1 does not only consist of the above mentioned core area, but also includes three long arm-like spiraling corridors. Along these corridors additional satellite dishes are to be constructed. These corridors are planned to run over "active farms". Servitudes on roads, power lines and pockets of land are planned. Restrictions will protect radio astronomy and affect farming activities for up to 11 km on either side of each of the spirals, making corridors of 22 km in width. These restrictions reduce or prohibit the generation of power, wind energy, electric fencing, spark plugs (petrol driven vehicles included),flying an aeroplane, constructing roads and houses, broadcasting a radio signals, operating microwaves, welding and the use of certain machines. Only radio frequencies below 100 Mhz, and above 25.5 Ghz will be tolerated in these areas.</p>
        
        <p><figure class="figure">
        <img class="img-responsive" src="img/sea-study-area.jpg" alt="SEA study area">
	<figcaption class="figure-caption text-right"> The total SEA area (SKA phase 1) comprises of 268 000 ha. Restrictions diminish farming activity along wide corridors indicated in blue.</figcaption>
	</figure></p>
	
	
        <p>A person who contravenes the restrictions will face a fine of up to R 1 000 000 (one million rand) or imprisonment, or both according to a warning issued by Government Gazette. Within South Africa one million Rand would represent a challenging amount for an average person to be fined. Currently an ordinary loaf of bread in South Africa cost from under R10 and may go up up to R15 depending on the type of bread, a litre of petrol sells for approximately R 13, while aviation fuel (Avgas) sells at just over R20 a litre.</p>
        ...
        <p>In a document published in 2005, <a href=Documents/26437_73_RITaskForce.pdf>"SKA Task Force on Regulatory Issues, November 2005"</a>  International experts recommend the implementation of the SKA project. On page 7 is stated "...a  radio-quiet  zone  (RQZ) is  necessary..." and on page 8, "Typical sectors that may be affected would be communications (both regulation  and communications infrastructure),land affairs, environmental  affairs, civil aviation  and  mineral  affairs. There  may be further impact at the state or provincial level in terms of roads, distribution networks of electrical power and other public services." These experts do not mention human rights, ecocide or the social and economic impact.</p>
	    <p>SKA phase 1 will be largely funded by the SKA International Partner States. These financial contributors are  the United Kingdom, Canada, Sweden, Italy, The Netherlands, Australia, New Zealand, India and China, according to the SKA official website. The SKA Organisation is a private company incorporated and has its <a href=https://www.skatelescope.org/ska-organisation/>head office in the United Kingdom</a> (The Office for the SKA Organisation (SKAO) is responsible for coordinating the global activities of the SKA project. This includes engineering, science, site evaluation, operations and public outreach. In addition there are several non-member States which benefit by receiving research data, such as Universities and the Max Planck Institution in Germany. The USA has part of its HERA project on the South African SKA core site. Further non-member states include France, Japan, Malta, Portugal, Spain and Switzerland.</p>
	...
	<figcaption class="figure-caption text-right">The Central Karoo Astronomically Advantaged Area (AAA)</figcaption>
	    ...
	    <p>The Council for Scientific and Industrial Research (CSIR) commissioned several experts to perform a <a href=https://www.ska.ac.za/about/strategic-environmental-assessment/>Strategic Environmental Assessment (SEA)</a> within the area affected by SKA phase 1. Research was collected on economic, social, environmental and heritage and cultural issues. This study ran throughout most of 2016, and a report is apparently due early in 2017. Once the report is approved the legislation could be passed.</P>
 ...
 <p>In the absence of original Expert reports, Save The Karoo has compiled some of the more obvious impacts for  consideration. Save The Karoo will upload these reports as soon as the CSIR make them available.</p>
	...
	<figcaption class="figure-caption text-right"></figcaption>
         ...
         <p>The Department of Science and Technology (DST) ran several workshops to engage with locals about SKA phase 1. Stakeholders were encouraged to object in writing rather than through debate at the meetings. Many written representations were forwarded to the DST but there are no known accounts of answers or solutions in return. Unfortunately these meetings were not well advertised and this limited participation. Also the minutes to these meetings (and also the meetings which SKA) were never shared with the public, and so continued discussion, negotiations and problem solving became impossible.</p>
          ...
          <li>Please comment on the <a href=http://eradicatingecocide.com/the-law/>International Ecocide Law</a> which came into effect in September 2016. Please explain why the South African Government canceled its ICC membership in October 2016.</li>
	...
	<p>Total area of Central Karoo AAA is 104691.254 km². The total area of the Northern Cape is roughly 372 8000 km2, and <a href=Documents/memorandum-AAA.pdf> most of the province was declared a AAA in 2010</a>.</p>
        


        <p>The perimeter of the Central Karoo AAA is  1 240.357 km. The perimeters along the spiraling corridors regulated by legislation, will be far greater, affecting thousands of commercial farms.</p>
...
68,401 km² - Tasmania (Australia)</p>
 ...
 - Total land area 372 889.36 km2.</p>
	    ...
	    <p>The people of the Karoo are asking the SKA International Partners States and the SKA Non-Partner States to take responsibility for the SKA SA project which they are aiding to finance. Please explain your intentions and policies in the Northern Cape and Africa at present and in the future. The people of the Karoo are uniting to protect the lives of future generations and safeguard the natural environment from exploitation and destruction. Ecocide is a crime.</p>	      
