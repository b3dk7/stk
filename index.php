...
<p> <img class="img-responsive" src="img/kat7.jpg" alt="Kat7">
 <figcaption class="figure-caption text-right">The seven-dish MeerKAT precursor array, KAT-7</figcaption></p>
        ...
        <p> South Africa and Australia jointly won the bid in 2012 and are the official hosts, but South Africa will host the majority share. <a href=Documents/SKA-Site-Advisory-Committee-16-Feb-2012.pdf>An International Site Advisory Committee decided which criteria determined the SKA host</a>. The South African SKA foundation is currently negotiating to buy more land (about 118 000 ha / or + - 36 farms) around the initial site, to create a larger core area of about 130 000 ha.</p>
	...
	<figcaption class="figure-caption text-right">SEA study area. Core = 130,000 ha. Spiral arms intended to contain satellite dished where restrictions diminish farming activity</figcaption>
	</figure>
 ...
 <p>In the absence of original Expert reports, Save The Karoo has compiled some of the more obvious impacts for  consideration. Save The Karoo will upload these reports as soon as the CSIR make them available.</p>
	     ...
	     <h2 id="economic-impact">Economic Impact</h2>
	   	 ...
	   	 <figure class="figure">
        <img class="img-responsive" src="img/sheep.jpg" alt="sheep">
	...
	<figcaption class="figure-caption text-right">The MeerKAT will finally consist of 64 dishes. SKA phase 1 will consist of thousands of satellite dishes</figcaption>
        ...
        <p><a href=https://www.environment.gov.za/sites/default/files/images/ska_studyarea.jpg>The size of the AAA</a> in comparison to other well know areas:
131,957 km2 - Greece
...
1240.357 km</p>
	...
	<figcaption class="figure-caption text-right"></figcaption>
	     ...
	     <p>On the 23 rd November 2015, the Department of Science and Technology published <a href=http://www.gov.za/sites/www.gov.za/files/39442_gon1166s.pdf>Government Gazette number 1166</a>. Eight corridors are indicated within the AAA. The following quote accompanies this map; " The map below depicts the protection corridors required for approximately 54 SKA  radio  astronomy  stations  located  within  the  Karoo  Central  Astronomy  Advantage  Area  1  but  which  fall  outside  the  20  km  radius  around  the  SKA  Virtual  Centre....The  perimeters  of  the  corridors  are  5  km  distant  on  either  side  of  the  spiral  arms  along which the SKA stations are to be positioned."</p>
