...
<head>
    ...
    <meta name="description" content="<?= isset($MetaDescription) ? $MetaDescription : "Default Title"?>">
    ...
    <script type="text/javascript">
      var _paq = _paq || [];
      _paq.push(["setDomains", ["*.savethekaroo.com"]]);
      _paq.push(['trackPageView']);
      _paq.push(['enableLinkTracking']);
      (function() {
	var u="//46.101.108.211/";
    ...
    <noscript><p><img src="//46.101.108.211/piwik.php?idsite=1" style="border:0;" alt="" /></p></noscript>
    <!-- End Piwik Code -->
